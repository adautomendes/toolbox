...
wget https://github.com/ryanoasis/nerd-fonts/releases/download/$NERDFONTS_VERSION/FiraCode.zip
wget https://github.com/ryanoasis/nerd-fonts/releases/download/$NERDFONTS_VERSION/UbuntuMono.zip
